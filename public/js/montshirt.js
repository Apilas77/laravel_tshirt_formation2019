...
if ($('.change_type').length) {
    // Au chargement de la page, on lance la fonction de chargement des tailles avec la valeur initialle du select value
    // Récupération de la valeur de l'option sélectionnée par défaut du chargement de la page
