...
@section('content')
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1>Ajouter une taille au produit: </h1>
        </div>
        <form action="{{route('backend_produit_store_size',['id'=>$produit->id])}}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <label for="type">Sélectionner un type de taille</label>
                    <select class="form-control change_type" data-id_produit="{{$produit->id}}" name="type_id" id="type_id">
        ...
        <table class="table table-striped">
            ...
            @foreach($produit->tailles as $taille)
                <tr>
                    ...
                    <td>
                        <a href="#"
                           class="btn btn-danger btn-sm remove_size"
