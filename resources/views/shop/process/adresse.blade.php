                ...
                <div class="col-md-12 order-md-1">
                    <form action="{{route(('commande_store_adresse'))}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <label for="email">Votre téléphone <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            <label for="addresse">Votre adresse <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="addresse" name="adresse"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <select class="custom-select d-block w-100" id="pays" required name="pays">
                                    ...
                                    <option
                                        @if(
                                            old('pays') == $code || (isset($adresse->pays) && $adresse->pays == $code))
                                            selected
                                        @endif value="{{$code}}">{{$p}}
                                    </option>
                                    @endforeach
