    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"
                aria-current="page"><a href="{{route('view_by_cat',['id'=>$produit->categorie->id])}}">{{$produit->categorie->nom}}</a>
            </li>
            @endif
        </ol>
    </nav>
                ...
                <div class="col-6">
                    ...
                    <form action="{{route('add_product_cart',['id'=>$produit->id])}}" method="post">
                        ...
                        @if(count($produit->tailles) == 0 )
                            ...
                            @else
                                <button disabled class="btn btn-danger my-2 btn-block">En rupture, désolé !</button>
                            @endif
                        @endif
                        </p>
                    </form>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <a href="{{route('view_product',['id'=>$produit->id])}}">
                                <img src="{{asset('produits/'.$recommandation->photo_principale)}}"
