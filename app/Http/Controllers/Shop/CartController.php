...
class CartController extends Controller
{
    ...
    public function add(Request $request) {
        ...
        // On récupére la qte max en stock afin de limiter la selection dans le panier
        // Condition crée dans le cas d'un produit sans taille (un mug par exemple)
    ...
    public function index() {
        ...
        // On crée une "condition" pour effecteur le calcul de la TVA à 20% sur le total du panier
    ...
    public function update (Request $request) {
        ...
        return redirect()->route('cart_index')->with('notice','Panier mis à jour');
    }
